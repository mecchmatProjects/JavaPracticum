...
7.Определіть клас Трикутник на площині. Визначити площу і периметр трикутника.
Створити масив / список / множину об&#39;єктів і підрахувати кількість трикутників різного
типу (рівносторонній, равнобедрений, прямокутний, довільний). Визначити для
кожної групи найбільший і найменшій по площаді (периметру) об&#39;єкт.
 */
